 ...
 *
 */
public class MihinanaManaraka 
{
	
	private static ArrayList<Piece> playerlocation;
	private static Coordinate points[];
	
	public static ArrayList<Integer> getEatablePiece(String string, 
			ArrayList<Piece> playerLocation,int selected, int firstSelected,Coordinate []point) 
	{
		...
		if(selected-firstSelected==8){
			...
			while(loop<45 &&isListPieceContainsPiece(loop, contrary)&&getAbs(loop)<getAbs(loop-8))
